...
model_input_image_size_height = 128
model_input_image_size_width = 128
...
class DataLoader_Train(Dataset):
    ...
    def __init__(self, file_list_A, file_list_B, file_list_DM):
    ...
    def __len__(self):
        if len(self.file_list_A) == len(self.file_list_B) == len(self.file_list_DM):
    ...
    def __getitem__(self, idx):
        ...
        return imgA_transformed, imgB_transformed, imgDM_transformed
